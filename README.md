...
Check the [releases](https://github.com/droboports/tftpd/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/tftpd.git
cd tftpd
./build.sh
ls -la *.tgz
```
...
* tftpd-hpa: https://www.kernel.org/pub/software/network/tftp/
